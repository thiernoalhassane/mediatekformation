...
## Execution des test en local
- Aller dans Run ensuite Set Project Configuration ensuite Customize
- Aller dans l'onglet Testing et cliquer sur PhpUnit
- Cocher UseBoostrap et UseBoostrap for create Unit Test ainsi que Use Xml Configuration ainsi que Test Project Using 'phpunit' Command et Run all* Test.php files in project
- Mettre a jour les liens 
    - pour boostrap le lien est C:\laragon\www\mediatekformation\tests\bootstrap.php
    - pour xml le lien est C:\laragon\www\mediatekformation\tests\configuration2.xml

- Aller sur Tools cliquer sur Options  cliquer sur l'onglet PHP et aller sur Framework and Tools et cliquer  phpUnit
    - Inserer dans phpUnitScript C:\laragon\www\mediatekformation\vendor\phpunit\phpunit\phpunit
    - Inserer dans Skeleton Generator Script C:\laragon\www\mediatekformation\vendor\vitexsoftware\phpunit-skeleton-generator\phpunit-skelgen

- ensuite ouvrir votre phpMyAdmin et cree une nouvelle base de donnée du nom de mediatekformation_test
- ensuite dans le terminal de votre projet executer les commandes suivantes : 

    APP_ENV=test php bin/console debug:config doctrine
